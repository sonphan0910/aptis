...
export default function ListeningStatementMatchingQuestion({
    ...
    let instruction = 'Listen to the conversation and match each statement with the correct person.';
    ...
    // hasAudio is now determined by audioUrlRef (updated via effect) 
