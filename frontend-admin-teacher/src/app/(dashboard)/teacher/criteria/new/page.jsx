...
import { DEFAULT_QUESTION_TYPES, DEFAULT_APTIS_TYPES, DEFAULT_SKILLS } from '@/constants/filterOptions';
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values) => {
      try {
        ...
        await dispatch(createCriteria(submitData));
            ...
            <Grid container spacing={2} sx={{ mt: 1 }}>
              <Grid item xs={12}>
                <TextField
                  ...
                  placeholder="Ví dụ: Chính xác về ngữ pháp, Sử dụng từ vựng phong phú"
                  required
                />
              </Grid>
                      ...
                      <Grid container spacing={2}>
                        ...
                        <Grid item xs={12}>
                          <TextField
                            ...
                            size="small"
                            placeholder="Ví dụ: Không có lỗi, Diễn đạt rõ ràng..."
                          />
                        </Grid>
                        <Grid item xs={12}>
